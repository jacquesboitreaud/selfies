        ...
        if pos_of_ring_symbol>=0:
            if (len(smiles[0:pos_of_ring_symbol])-len(smiles[0:pos_of_ring_symbol].replace('[','')))>2:
                ...
                if bilocal_ring_function:
                    ...
                    target_atom_type_2chars=smiles[r_count-2:r_count]
                    if target_atom_type=='F' or target_atom_type=='H' or target_atom_type_2chars =='Cl' or target_atom_type_2chars =='Br' or target_atom_type == 'I':
